...
import com.rve.musicplayer.data.database.SongEntity // Necesario para datos de prueba
import com.rve.musicplayer.data.database.AlbumEntity
import com.rve.musicplayer.data.database.ArtistEntity
import com.rve.musicplayer.data.model.Song // Para verificar el mapeo
...
class MusicRepositoryImplTest {
    ...
    private val mockTelegramCacheManager: com.rve.musicplayer.data.telegram.TelegramCacheManager = mockk(relaxed = true)
    private val mockTelegramRepository: com.rve.musicplayer.data.telegram.TelegramRepository = mockk(relaxed = true)
    private val mockTelegramCacheManagerProvider: Lazy<com.rve.musicplayer.data.telegram.TelegramCacheManager> = mockk()
    private val mockTelegramRepositoryProvider: Lazy<com.rve.musicplayer.data.telegram.TelegramRepository> = mockk()
