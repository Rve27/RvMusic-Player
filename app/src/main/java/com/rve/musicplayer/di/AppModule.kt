package com.rve.musicplayer.di
...
import com.rve.musicplayer.BuildConfig
import com.rve.musicplayer.PixelPlayApplication
import com.rve.musicplayer.data.database.AlbumArtThemeDao
import com.rve.musicplayer.data.database.EngagementDao
import com.rve.musicplayer.data.database.FavoritesDao
import com.rve.musicplayer.data.database.GDriveDao
import com.rve.musicplayer.data.database.LyricsDao
import com.rve.musicplayer.data.database.LocalPlaylistDao
import com.rve.musicplayer.data.database.MusicDao
import com.rve.musicplayer.data.database.PixelPlayDatabase
import com.rve.musicplayer.data.database.SearchHistoryDao
import com.rve.musicplayer.data.database.TransitionDao
...
import com.rve.musicplayer.data.preferences.dataStore
import com.rve.musicplayer.data.media.SongMetadataEditor
import com.rve.musicplayer.data.network.deezer.DeezerApiService
...
import com.rve.musicplayer.data.repository.LyricsRepository
import com.rve.musicplayer.data.repository.LyricsRepositoryImpl
import com.rve.musicplayer.data.repository.MediaStoreSongRepository
import com.rve.musicplayer.data.repository.MusicRepository
import com.rve.musicplayer.data.repository.MusicRepositoryImpl
import com.rve.musicplayer.data.repository.SongRepository
import com.rve.musicplayer.data.repository.TransitionRepository
import com.rve.musicplayer.data.repository.TransitionRepositoryImpl
...
object AppModule {
    ...
    fun provideSessionToken(@ApplicationContext context: Context): androidx.media3.session.SessionToken {
        return androidx.media3.session.SessionToken(
            context,
            android.content.ComponentName(context, com.rve.musicplayer.data.service.MusicService::class.java)
        )
    }
    ...
    @Singleton
    @Provides
    fun provideQqMusicDao(database: PixelPlayDatabase): com.rve.musicplayer.data.database.QqMusicDao {
        return database.qqmusicDao()
    }

    @Singleton
    @Provides
    fun provideNavidromeDao(database: PixelPlayDatabase): com.rve.musicplayer.data.database.NavidromeDao {
    ...
    fun provideSongRepository(
        @ApplicationContext context: Context,
        mediaStoreObserver: com.rve.musicplayer.data.observer.MediaStoreObserver,
    ...
    @Singleton
    @Provides
    fun provideTelegramDao(database: PixelPlayDatabase): com.rve.musicplayer.data.database.TelegramDao {
        return database.telegramDao()
    }

    @Singleton
    @Provides
    fun provideNeteaseDao(database: PixelPlayDatabase): com.rve.musicplayer.data.database.NeteaseDao {
        ...
        return OkHttpClient.Builder()
            ...
            .addInterceptor { chain ->
                ...
                val requestWithUserAgent = originalRequest.newBuilder()
                    .header("User-Agent", "RvMusic Player/1.0 (Android; Music Player)")
                    .build()
