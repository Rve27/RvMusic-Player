...
fun BetaInfoBottomSheet(modifier: Modifier = Modifier) {
    ...
    val issuesUrl = "https://github.com/Rve27/RvMusic-Player/issues"
    val reportUrl = "https://github.com/Rve27/RvMusic-Player/issues/new/choose"
                ...
                Surface(
                    ...
                    Row(
                        ...
                        Column(
                            ...
                            Text(
                                text = "Welcome to RvMusic Player 0.6.0-beta",
                                style = MaterialTheme.typography.titleMedium,
                                color = MaterialTheme.colorScheme.onSurface
                            )
                            Text(
