package com.rve.musicplayer.presentation.telegram.channel
...
import com.rve.musicplayer.presentation.viewmodel.ConnectivityStateHolder
        ...
        viewModelScope.launch {
            ...
            if (fetchedSongs.isNotEmpty()) {
                ...
                if (chat != null) {
                    ...
                    val entity = com.rve.musicplayer.data.database.TelegramChannelEntity(
                        chatId = chat.id,
                        title = chat.title,
