...
import com.rve.musicplayer.data.media.ImageCacheManager
import com.rve.musicplayer.data.media.MetadataEditError
...
import com.rve.musicplayer.utils.FileDeletionUtils
    ...
    suspend fun saveMetadata(
        ...
        val finalCoverArtUpdate = if (coverArtUpdate == null) {
            val existingMetadata = try {
                 com.rve.musicplayer.data.media.AudioMetadataReader.read(java.io.File(song.path))
            } catch (e: Exception) {
                null
            }
