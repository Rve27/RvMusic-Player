...
import com.rve.musicplayer.data.repository.NoLyricsFoundException
...
class LyricsStateHolder @Inject constructor(
    ...
    fun initialize(
        ...
        stablePlayerState: StateFlow<com.rve.musicplayer.presentation.viewmodel.StablePlayerState>
    ) {
