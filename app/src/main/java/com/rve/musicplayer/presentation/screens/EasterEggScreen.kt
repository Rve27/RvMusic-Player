...
import com.rve.musicplayer.presentation.components.brickbreaker.BrickBreakerOverlay
...
fun EasterEggScreen(
    ...
    LaunchedEffect(hasShownFanToast) {
        ...
        Toast.makeText(context, "Thank you for using RvMusic Player!", Toast.LENGTH_SHORT).show()
