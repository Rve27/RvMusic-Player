...
import com.rve.musicplayer.data.github.GitHubAnnouncementPropertiesService
import com.rve.musicplayer.data.github.PlayStoreAnnouncementRemoteConfig
import com.rve.musicplayer.data.preferences.AppThemeMode
import com.rve.musicplayer.data.preferences.NavBarStyle
...
import com.rve.musicplayer.data.service.MusicService
import com.rve.musicplayer.data.worker.SyncProgress
import com.rve.musicplayer.presentation.components.AppSidebarDrawer
import com.rve.musicplayer.presentation.components.CrashReportDialog
import com.rve.musicplayer.presentation.components.DismissUndoBar
import com.rve.musicplayer.presentation.components.DrawerDestination
import com.rve.musicplayer.presentation.components.MiniPlayerBottomSpacer
...
import com.rve.musicplayer.presentation.components.NavBarContentHeightFullWidth
import com.rve.musicplayer.presentation.components.PlayerInternalNavigationBar
import com.rve.musicplayer.presentation.components.PlayStoreAnnouncementDefaults
import com.rve.musicplayer.presentation.components.PlayStoreAnnouncementDialog
import com.rve.musicplayer.presentation.components.PlayStoreAnnouncementUiModel
import com.rve.musicplayer.presentation.components.UnifiedPlayerSheet
import com.rve.musicplayer.presentation.components.UnifiedPlayerSheetV2
import com.rve.musicplayer.presentation.navigation.AppNavigation
import com.rve.musicplayer.presentation.navigation.Screen
import com.rve.musicplayer.presentation.screens.SetupScreen
import com.rve.musicplayer.presentation.viewmodel.MainViewModel
import com.rve.musicplayer.presentation.viewmodel.PlayerViewModel
import com.rve.musicplayer.ui.theme.PixelPlayTheme
import com.rve.musicplayer.utils.CrashHandler
...
import com.rve.musicplayer.presentation.utils.AppHapticsConfig
import com.rve.musicplayer.presentation.utils.LocalAppHapticsConfig
import com.rve.musicplayer.presentation.utils.NoOpHapticFeedback
import com.rve.musicplayer.utils.CrashLogData
...
class MainActivity : ComponentActivity() {
    ...
    private fun handleIntent(intent: Intent?) {
        ...
        when {
            ...
            intent.action == "com.rve.musicplayer.ACTION_PLAY_SONG" -> {
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
                     intent.getParcelableExtra("song", com.rve.musicplayer.data.model.Song::class.java)?.let { song ->
                         playerViewModel.playSong(song)
                     }
                } else {
                     @Suppress("DEPRECATION")
                     intent.getParcelableExtra<com.rve.musicplayer.data.model.Song>("song")?.let { song ->
                         playerViewModel.playSong(song)
                     }
                }
                intent.action = null
                ...
                onDestinationSelected = { destination ->
                    ...
                    when (destination) {
                        ...
                        DrawerDestination.Telegram -> {
                            val intent = Intent(this@MainActivity, com.rve.musicplayer.presentation.telegram.auth.TelegramLoginActivity::class.java)
                            startActivity(intent)
                        }
                        else -> {}
                    }
