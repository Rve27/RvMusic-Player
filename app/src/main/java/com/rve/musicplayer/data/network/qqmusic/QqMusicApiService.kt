package com.rve.musicplayer.data.network.qqmusic
...
class QqMusicApiService @Inject constructor(
    ...
    private val okHttpClient: OkHttpClient = baseOkHttpClient.newBuilder()
        ...
        .addInterceptor(com.rve.musicplayer.data.remote.qqmusic.QQMusicEncryptInterceptor(
            com.rve.musicplayer.data.remote.qqmusic.QQSignGenerator(context)
        ))
