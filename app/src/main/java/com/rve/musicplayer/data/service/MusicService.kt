...
import com.rve.musicplayer.data.model.PlayerInfo
import com.rve.musicplayer.data.model.PlaybackQueueItemSnapshot
import com.rve.musicplayer.data.model.PlaybackQueueSnapshot
import com.rve.musicplayer.data.preferences.EqualizerPreferencesRepository
...
import com.rve.musicplayer.data.service.player.TransitionController
import com.rve.musicplayer.ui.glancewidget.ControlWidget4x2
...
import com.rve.musicplayer.data.equalizer.EqualizerManager
import com.rve.musicplayer.data.model.WidgetThemeColors
...
import com.rve.musicplayer.ui.glancewidget.BarWidget4x1
import com.rve.musicplayer.ui.glancewidget.GridWidget2x2
import androidx.compose.material3.dynamicDarkColorScheme
import androidx.compose.material3.dynamicLightColorScheme
import com.rve.musicplayer.data.preferences.ThemePreference
import com.rve.musicplayer.data.service.auto.AutoMediaBrowseTree
import com.rve.musicplayer.data.service.wear.buildWearThemePalette
import com.rve.musicplayer.data.service.wear.WearStatePublisher
import com.rve.musicplayer.presentation.viewmodel.ColorSchemePair
import com.rve.musicplayer.shared.WearIntents
import com.rve.musicplayer.utils.ArtworkTransportSanitizer
...
class MusicService : MediaLibraryService() {
    ...
    @Inject
    lateinit var replayGainManager: com.rve.musicplayer.data.media.ReplayGainManager
    ...
    companion object {
        ...
        const val ACTION_SLEEP_TIMER_EXPIRED = "com.rve.musicplayer.ACTION_SLEEP_TIMER_EXPIRED"
        const val EXTRA_FORCE_FOREGROUND_ON_START =
            "com.rve.musicplayer.extra.FORCE_FOREGROUND_ON_START"
        ...
        private const val APP_PACKAGE_PREFIX = "com.rve.musicplayer"
    ...
    private suspend fun buildPlayerInfo(): PlayerInfo {
        ...
        val queueItems = mutableListOf<com.rve.musicplayer.data.model.QueueItem>()
        ...
        if (!snapshotTimeline.isEmpty) {
            ...
            for (i in startIndex until endIndex) {
                ...
                if (songId != null) {
                    ...
                    queueItems.add(
                        com.rve.musicplayer.data.model.QueueItem(
                            id = songId,
    ...
    private suspend fun loadArtworkBytesForWidget(uri: Uri): ByteArray? {
        ...
        val isLocalArtworkUri = com.rve.musicplayer.utils.LocalArtworkUri.isLocalArtworkUri(uriString)
        return when {
