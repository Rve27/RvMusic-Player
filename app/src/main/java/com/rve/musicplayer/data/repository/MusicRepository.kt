...
import com.rve.musicplayer.data.model.Playlist
import com.rve.musicplayer.data.model.SearchFilterType
import com.rve.musicplayer.data.model.SearchHistoryItem
import com.rve.musicplayer.data.model.SearchResultItem
import com.rve.musicplayer.data.model.Song
import kotlinx.coroutines.flow.Flow
import com.rve.musicplayer.data.database.TelegramChannelEntity
...
interface MusicRepository {
    ...
    fun getPaginatedFavoriteSongs(
        ...
        storageFilter: com.rve.musicplayer.data.model.StorageFilter = com.rve.musicplayer.data.model.StorageFilter.ALL
     ...
     */
    fun getAlbums(storageFilter: com.rve.musicplayer.data.model.StorageFilter = com.rve.musicplayer.data.model.StorageFilter.ALL): Flow<List<Album>> // Existing Flow for reactive updates
     ...
     */
    fun getGenres(): Flow<List<com.rve.musicplayer.data.model.Genre>>
    ...
    fun getMusicFolders(
        storageFilter: com.rve.musicplayer.data.model.StorageFilter = com.rve.musicplayer.data.model.StorageFilter.ALL
    ): Flow<List<com.rve.musicplayer.data.model.MusicFolder>>
    ...
    suspend fun saveTelegramTopics(chatId: Long, topics: List<com.rve.musicplayer.data.database.TelegramTopicEntity>)
    /** Replaces the full topic list for a channel, deleting any topics that no longer exist. */
    suspend fun replaceTopicsForChannel(chatId: Long, freshTopics: List<com.rve.musicplayer.data.database.TelegramTopicEntity>)
    suspend fun getTopicsForChannel(chatId: Long): List<com.rve.musicplayer.data.database.TelegramTopicEntity>
    suspend fun replaceTelegramSongsForTopic(chatId: Long, threadId: Long, topicName: String, songs: List<Song>)

    val telegramRepository: com.rve.musicplayer.data.telegram.TelegramRepository
