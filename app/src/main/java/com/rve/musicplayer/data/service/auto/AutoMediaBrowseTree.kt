package com.rve.musicplayer.data.service.auto
...
class AutoMediaBrowseTree @Inject constructor(
    ...
    companion object {
        ...
        const val CONTEXT_TYPE_EXTRA = "com.rve.musicplayer.auto.extra.CONTEXT_TYPE"
        const val CONTEXT_ID_EXTRA = "com.rve.musicplayer.auto.extra.CONTEXT_ID"
        const val CONTEXT_PARENT_ID_EXTRA = "com.rve.musicplayer.auto.extra.CONTEXT_PARENT_ID"
