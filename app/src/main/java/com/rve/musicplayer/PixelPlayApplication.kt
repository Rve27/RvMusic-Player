...
import com.rve.musicplayer.utils.MediaMetadataRetrieverPool
...
class PixelPlayApplication : Application(), ImageLoaderFactory, Configuration.Provider {
    ...
    @Inject
    lateinit var telegramStreamProxy: dagger.Lazy<com.rve.musicplayer.data.telegram.TelegramStreamProxy>

    @Inject
    lateinit var neteaseStreamProxy: com.rve.musicplayer.data.netease.NeteaseStreamProxy

    @Inject
    lateinit var qqMusicStreamProxy: com.rve.musicplayer.data.qqmusic.QqMusicStreamProxy

    @Inject
    lateinit var navidromeStreamProxy: com.rve.musicplayer.data.navidrome.NavidromeStreamProxy

    @Inject
    lateinit var telegramCacheManager: dagger.Lazy<com.rve.musicplayer.data.telegram.TelegramCacheManager>

    @Inject
    lateinit var telegramCoilFetcherFactory: dagger.Lazy<com.rve.musicplayer.data.image.TelegramCoilFetcher.Factory>
