...
import com.rve.musicplayer.data.model.QueueItem
import com.rve.musicplayer.utils.createScalableBackgroundBitmap
...
class PixelPlayGlanceWidget : GlanceAppWidget() {
    ...
    private fun WidgetUi(
        ...
        val title = playerInfo.songTitle.ifEmpty { "RvMusic Player" }
