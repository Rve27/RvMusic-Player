package com.rve.musicplayer.ui.glancewidget
...
object PlayerActions {
    ...
    const val PLAY_PAUSE = "com.rve.musicplayer.ACTION_WIDGET_PLAY_PAUSE"
    const val NEXT = "com.rve.musicplayer.ACTION_WIDGET_NEXT"
    const val PREVIOUS = "com.rve.musicplayer.ACTION_WIDGET_PREVIOUS"
    const val FAVORITE = "com.rve.musicplayer.ACTION_WIDGET_FAVORITE"
    const val PLAY_FROM_QUEUE = "com.rve.musicplayer.ACTION_WIDGET_PLAY_FROM_QUEUE"
    const val SHUFFLE = "com.rve.musicplayer.ACTION_WIDGET_SHUFFLE"
    const val REPEAT = "com.rve.musicplayer.ACTION_WIDGET_REPEAT"
}
